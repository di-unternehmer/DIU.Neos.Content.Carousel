            ...
            if (!i.isTouchEvent || 'touchmove' === l.type) {
                ...
                if (!this.allowTouchMove)
                    return (
                        ...
                        void (
                            i.isTouched &&
                            (S(a, { startX: d, startY: h, currentX: d, currentY: h }), (i.touchStartTime = x()))
                        )
                    );
                ...
                if (
                    ...
                    if (
                        !(this.params.threshold && Math.sqrt(Math.pow(p, 2) + Math.pow(u, 2)) < this.params.threshold)
                    ) {
                        var c;
                                    ...
                                    ? ((f = !1),
                                      s.resistance &&
                                          (i.currentTranslate =
                                              this.minTranslate() -
                                              1 +
                                              Math.pow(-this.minTranslate() + i.startTranslate + v, g)))
                                    : v < 0 &&
                                      ...
                                      s.resistance &&
                                          (i.currentTranslate =
                                              this.maxTranslate() +
                                              1 -
                                              Math.pow(this.maxTranslate() - i.startTranslate - v, g))),
            ...
            if (s.freeMode) {
                ...
                if (s.freeModeMomentum) {
                    ...
                    if (b < t.maxTranslate())
                        ...
                        b = -(b =
                            Math.abs(o[M] - b) < Math.abs(o[M - 1] - b) || 'next' === t.swipeDirection
                                ? o[M]
                                : o[M - 1]);
                    }
                    if (
        ...
        H = {
            ...
            slide: {
                ...
                slideToClosest: function (e, t, i, s) {
                    ...
                    return (
                        (a = Math.max(a, 0)), (a = Math.min(a, this.slidesGrid.length - 1)), this.slideTo(a, e, t, i)
                    );
                },
            ...
            manipulation: {
                ...
                addSlide: function (e, t) {
                    var i = this.$wrapperEl,
                        ...
                        a = this.activeIndex;
                    s.loop &&
                        ((a -= this.loopedSlides), this.loopDestroy(), (this.slides = i.children('.' + s.slideClass)));
                ...
                removeSlide: function (e) {
                    var t = this.params,
                        ...
                        s = this.activeIndex;
                    t.loop &&
                        ((s -= this.loopedSlides), this.loopDestroy(), (this.slides = i.children('.' + t.slideClass)));
                    var a,
                        r = s;
                    if ('object' == typeof e && 'length' in e) {
                ...
                if ((e = o[0])) {
                    ...
                    return (
                        ...
                        e && e.shadowRoot && e.shadowRoot.querySelector
                            ? ((h = m(e.shadowRoot.querySelector('.' + n.params.wrapperClass))).children = function (
                                  e
                              ) {
                                  return o.children(e);
                              })
        ...
        J = {
            ...
            init: function () {
                if (this.params.scrollbar.el) {
                    ...
                    0 === a.length &&
                        ((a = m('<div class="' + this.params.scrollbar.dragClass + '"></div>')), s.append(a)),
                        ...
                        e.gestures
                            ...
                            : 'touchstart' === this.touchEvents.start &&
                              ...
                              this.touchEvents.cancel &&
                                  this.$wrapperEl.on(this.touchEvents.cancel, a, t.onGestureEnd, i)),
                        this.$wrapperEl.on(
            ...
            setTranslate: function () {
                ...
                for (var c = 0; c < s.length; c += 1) {
                    ...
                    var T =
                        ...
                        'px)';
                    if (
                        (b <= 1 && b > -1 && ((u = 90 * f + 90 * b), n && (u = 90 * -f - 90 * b)),
                        v.transform(T),
                        d.slideShadows)
                    ) {
                        ...
                        0 === C.length &&
                            ((C = m('<div class="swiper-slide-shadow-' + (h ? 'left' : 'top') + '"></div>')),
                            v.append(C)),
                            0 === S.length &&
        ...
        de = {
            setTranslate: function () {
                for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                    ...
                    s.transform(
                        'translate3d(' + l + 'px, ' + o + 'px, 0px) rotateX(' + n + 'deg) rotateY(' + r + 'deg)'
                    );
                }
            },
            setTransition: function (e) {
            ...
            setTranslate: function () {
                for (
                    ...
                    if ((u.transform(T), (u[0].style.zIndex = 1 - Math.abs(Math.round(v))), a.slideShadows)) {
                        ...
                        0 === C.length &&
                            ((C = m('<div class="swiper-slide-shadow-' + (r ? 'left' : 'top') + '"></div>')),
                            u.append(C)),
                            0 === S.length &&
